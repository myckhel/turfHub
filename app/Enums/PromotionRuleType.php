...
enum PromotionRuleType: string
{
  ...
  case KNOCKOUT_WINNERS = 'knockout_winners';
  case CUSTOM = 'custom';
  ...
  public function label(): string
  {
    return match ($this) {
      ...
      self::KNOCKOUT_WINNERS => 'Knockout Winners',
  ...
  public function description(): string
  {
    return match ($this) {
      ...
      self::KNOCKOUT_WINNERS => 'Promote teams that won their knockout fixtures (based on match results, not rankings)',
