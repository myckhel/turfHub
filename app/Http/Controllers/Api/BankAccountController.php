...
class BankAccountController extends Controller
{
     ...
     */
    public function getUserBankAccounts(): JsonResponse
    {
        try {
            $user = Auth::user();
     ...
     */
    public function getTurfBankAccounts(int $turfId): JsonResponse
    {
        try {
            $user = Auth::user();
            ...
            return response()->json([
                'status' => true,
                'message' => 'Turf bank accounts retrieved successfully',
                'data' => [
                    'turf_id' => $turf->id,
                    'turf_name' => $turf->name,
            ...
            return response()->json([
                'status' => false,
                'message' => 'Failed to retrieve turf bank accounts',
                'error' => $e->getMessage()
            ], 500);
        }
    }
