...
interface BettingIndexProps {
  turfId: number;
}

const BettingIndex = ({ turfId }: BettingIndexProps) => {
  ...
  const filteredMarkets = markets.filter((market) => {
    const matchesSearch =
      !deferredSearchTerm ||
      market.name.toLowerCase().includes(deferredSearchTerm.toLowerCase()) ||
      market.game_match?.first_team?.name?.toLowerCase().includes(deferredSearchTerm.toLowerCase()) ||
      market.game_match?.second_team?.name?.toLowerCase().includes(deferredSearchTerm.toLowerCase());
  ...
  // Group markets by status for tabs
...
BettingIndex.displayName = 'BettingIndex';
