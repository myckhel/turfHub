...
class RankingCalculatorTest extends TestCase
{
    ...
    {
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 2, 'score' => ['home' => 3, 'away' => 1]],
            (object) ['home_team_id' => 3, 'away_team_id' => 4, 'score' => ['home' => 2, 'away' => 2]],
        ]);
    ...
    {
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 2, 'score' => ['home' => 2, 'away' => 0]],
        ]);
    ...
    public function test_goal_statistics(): void
    {
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 2, 'score' => ['home' => 3, 'away' => 1]],
            (object) ['home_team_id' => 1, 'away_team_id' => 3, 'score' => ['home' => 2, 'away' => 2]],
        ]);
    ...
    public function test_applies_tie_breakers(): void
    {
        ...
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 3, 'score' => ['home' => 2, 'away' => 0]],
            (object) ['home_team_id' => 2, 'away_team_id' => 4, 'score' => ['home' => 1, 'away' => 0]],
        ]);
    ...
    {
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 2, 'score' => ['home' => 1, 'away' => 0]],
        ]);
    ...
    {
        $fixtures = collect([
            (object) ['home_team_id' => 1, 'away_team_id' => 2, 'score' => ['home' => 3, 'away' => 0]], // Team 1: 3pts
            (object) ['home_team_id' => 3, 'away_team_id' => 4, 'score' => ['home' => 1, 'away' => 1]], // Team 3,4: 1pt each
            (object) ['home_team_id' => 2, 'away_team_id' => 3, 'score' => ['home' => 2, 'away' => 0]], // Team 2: 3pts
        ]);
