...
class TieBreakersTest extends TestCase
{
  ...
  public function test_head_to_head_tie_breaker(): void
  {
    ...
    $fixtures = collect([
      (object) ['first_team_id' => 1, 'second_team_id' => 2, 'first_team_score' => 2, 'second_team_score' => 1],
      (object) ['first_team_id' => 1, 'second_team_id' => 3, 'first_team_score' => 3, 'second_team_score' => 0],
      (object) ['first_team_id' => 2, 'second_team_id' => 3, 'first_team_score' => 4, 'second_team_score' => 0],
    ]);
  ...
  public function test_head_to_head_with_multiple_matches(): void
  {
    ...
    $fixtures = collect([
      (object) ['first_team_id' => 1, 'second_team_id' => 2, 'first_team_score' => 2, 'second_team_score' => 1],
      (object) ['first_team_id' => 2, 'second_team_id' => 1, 'first_team_score' => 1, 'second_team_score' => 1],
    ]);
  ...
  public function test_head_to_head_ignores_non_relevant_matches(): void
  {
    ...
    $fixtures = collect([
      (object) ['first_team_id' => 1, 'second_team_id' => 2, 'first_team_score' => 2, 'second_team_score' => 1],
      (object) ['first_team_id' => 1, 'second_team_id' => 3, 'first_team_score' => 5, 'second_team_score' => 0], // Should be ignored
      (object) ['first_team_id' => 2, 'second_team_id' => 3, 'first_team_score' => 3, 'second_team_score' => 0], // Should be ignored
    ]);
  ...
  public function test_head_to_head_with_three_way_tie(): void
  {
    ...
    $fixtures = collect([
      (object) ['first_team_id' => 1, 'second_team_id' => 2, 'first_team_score' => 2, 'second_team_score' => 0], // Team 1 wins
      (object) ['first_team_id' => 2, 'second_team_id' => 3, 'first_team_score' => 1, 'second_team_score' => 0], // Team 2 wins
      (object) ['first_team_id' => 3, 'second_team_id' => 1, 'first_team_score' => 1, 'second_team_score' => 1], // Draw
    ]);
